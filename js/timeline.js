...
function Timeline(element, data, $, undefined) {
    ...
    this._readmore_text     = 'View Singleton';
    this._loadmore_text     = 'View More';
    ...
    this._createElement = function(element_data, position) {
        ...
        if (element_data.title) {
            var titleHtml = '<span class="timeline_title_label">' + element_data.title + '</span><span class="timeline_title_date">' + element_data.city + '</span>';
            var title = $('<div>').addClass('timeline_title').html('<a href="'+element_data.readmore+'">'+titleHtml+'</a>').appendTo(element_box);
        } else {
        ...
        switch (element_data.type) {
            ...
            case 'blog_post':
                ...
                $('<div>').addClass('slider_container').html('<a href="'+element_data.readmore+'">'+html+'</a>').appendTo(element_box);

                // content DIV
                if (element_data.content) {
                    $('<div>').addClass('content').html('<a style="text-decoration: none;" href="'+element_data.readmore+'">'+element_data.content+'</a>').appendTo(element_box);
                }

                if (element_data.readmore) {
                    $('<div>').addClass('readmore').html('<a style="text-decoration: none;" class="btn btn-block btn-success" href="' + element_data.readmore + '">' + SELF._readmore_text + '</a>').appendTo(element_box);
                }
